...
/*   Updated: 2022/05/17 21:26:45 by ocartier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Copy ClapTrap constructor called for " << src.getName() << std::endl;
	*this = src;
}

ClapTrap::~ClapTrap(void)
{
	std::cout << "Destructor ClapTrac called for " << this->_name << std::endl;
}
...
ClapTrap	&ClapTrap::operator =(const ClapTrap &src)
{
	if (this != &src)
	{
		std::cout << "Copy assignement ClapTrap operator called for " << src.getName() << std::endl;
